...
contract PharmaChain {
   ...
   function getAdmin(address _id) public view returns (string memory , Status, address , address, uint) {
       
        admin memory _admin=admins[_id];
        //get admin info
        return(_admin.name , _admin.status, _admin.adminaddress, _admin.createdby, _admin.createdat);
    ...
    function createSup ( uint _supid, string memory _supname, string memory _rawmat, uint _price, address _supaddress ) verifiedAdmin public returns (bool) {
    ...
    function searchSup (uint _supid ) public view returns ( uint, string memory, string memory, uint, Status) {
    ...
    function createQuot ( uint _mfgid, string memory _rawmat, uint _quantity, uint _price, uint _supid ) public  returns (bool) {
    ...
    function getQuot (uint _quotid ) public view returns (string memory, uint, uint, QuoteStatus, uint, uint, uint) {
